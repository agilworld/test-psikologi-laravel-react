...
export default () => {
  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 bg-green-700 md:flex-shrink-0 md:w-56 md:justify-center">
      <InertiaLink className="mt-1" href="/">
        <img src={LogoUrl} className="text-white fill-current" />
      </InertiaLink>
